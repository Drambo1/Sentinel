...
/**
 * Test cases for {@link InMysqlMetricsRepository}.
 *
 * @author Nick Tan
 */
public class InMysqlMetricsRepositoryTest {
    ...
    private InMysqlMetricsRepository inMysqlMetricsRepository;
    private ExecutorService executorService;
    private MetricMapper metricMapper;

    @Before
    public void setUp() throws Exception {
        inMysqlMetricsRepository = new InMysqlMetricsRepository();
    ...
    public void testSave() {
        ...
        inMysqlMetricsRepository.save(entry);
        List<String> resources = inMysqlMetricsRepository.listResourcesOfApp("testSave");
    ...
    public void testSaveAll() {
        ...
        inMysqlMetricsRepository.saveAll(entities);
        List<String> result = inMysqlMetricsRepository.listResourcesOfApp("testSaveAll");
    ...
    public void testExpireMetric() {
        ...
        inMysqlMetricsRepository.save(expireEntry);
        ...
        List<MetricEntity> list = inMysqlMetricsRepository.queryByAppAndResourceBetween(
            ...
            futures.add(CompletableFuture.runAsync(() -> {
                        try {
                            ...
                            if (finalJ % 2 == 0) {
                                ...
                                inMysqlMetricsRepository.listResourcesOfApp(DEFAULT_APP);
                            }
